...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'rails',                       '~> 8.0.0.1'
  ...
  s.add_dependency 'sunspot_rails',               '~> 2.6.0' 
  s.add_dependency 'jquery-ui-rails',             '~> 6.0.1'
  s.add_dependency 'jquery-rails',                '~> 4.6.0' 
  s.add_dependency 'jquery-datatables-rails',     '~> 3.4.0' 
  s.add_dependency 'uglifier',                    '~> 4.2.1'
  s.add_dependency 'cancancan',                   '~> 3.5.0'
  ...
  s.add_dependency 'mini_magick',                 '>= 4.13.2', '< 5'
  ...
  s.add_dependency 'slim-rails',                  '~> 3.6.3' 
  ...
  s.add_dependency 'video_info',                  '~> 4.2.0'
