    ...
    module Controllers
      ...
      module Menus
        ...
        private
          ...
          #
          def menu_params #:doc:
            params[:menu].permit(extended_parameters, :name, :subtitle, :seq, :target, :external_link, :css_class, :css_body_class, :main_pic, :follow, :parent_id, :active, :visible, :description, :lang_id, :fake, :content_ids => [],:available_module_ids => [],
